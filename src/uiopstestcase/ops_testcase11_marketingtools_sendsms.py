...
class OpsTestcase11MarketingToolsSendSms(unittest.TestCase):
    ...
    def test_ops_testcase11_MarketingToolsSendSms(self):
        ...
        driver.find_element_by_css_selector("div.container div.navbar-collapse.collapse.navbar-responsive-collapse ul.nav.navbar-nav li:nth-child(10).dropdown ul.dropdown-menu li:nth-child(1) a").send_keys(Keys.ENTER)
