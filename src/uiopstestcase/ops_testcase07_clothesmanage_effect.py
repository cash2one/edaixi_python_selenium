...
class OpsTestcase07clothesmanageeffect(unittest.TestCase):
    ...
    def test_ops_testcase07_clothesmanageeffect(self):
        ...
        driver.find_element_by_css_selector("div.container div.navbar-collapse.collapse.navbar-responsive-collapse ul.nav.navbar-nav li:nth-child(6).dropdown ul.dropdown-menu li:nth-child(5) a").send_keys(Keys.ENTER)
