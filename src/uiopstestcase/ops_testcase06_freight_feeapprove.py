...
class OpsTestcase06freightfeeapprove(unittest.TestCase):
    ...
    def test_ops_testcase06_freightfeeapprove(self):
        ...
        self.assertEqual(driver.title, u"e袋洗城市运营后台")
        driver.find_element_by_css_selector("div.container div.navbar-collapse.collapse.navbar-responsive-collapse ul.nav.navbar-nav li:nth-child("+str(5)+").dropdown ul.dropdown-menu li:first-child a").send_keys(Keys.ENTER)
